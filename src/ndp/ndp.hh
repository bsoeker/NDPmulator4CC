...
private:
  ...
  private:
    ...
    public:
      ...
      AddrRange getAddrRange() { return addrRange; };

      uint8_t *getDataPtr() { return dataPtr; };
    };
  ...
  public:
    ...
    bool requestComplete() { return pendingSubRequests.empty(); };

    Addr getAddr() { return addrRange.start(); };

    uint8_t *getDataPtr() { return dataPtr; };

    size_t getSize() { return addrRange.size(); };

    bool isWrite() { return writeRequest; };

    int countPendingSubRequests() { return pendingSubRequests.size(); }
  };
